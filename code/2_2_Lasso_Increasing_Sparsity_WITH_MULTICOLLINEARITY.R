...
# Parameters for covariance matrix with correlation (Toeplitz matrix)
rho = 0.5
# = 100
sigma_grid = c(1,1)
...
for(i in grid_sparse){ # grid sparse is a sequence from 0 to 100 by 2
  ...
  for(r in 1:reps){
   ...
   # cat("\n")
    ...
    cov_sim_sparse = varcov_matrix_toeplitz(rho=rho, covariates=length_grid, sigma_grid=sigma_grid)
    #Define DGP
...
write_xlsx(lasso_results_df, "C:\\Users\\57300\\Documents\\Cristian Gutierrez\\Uni - Bonn\\5. Semester\\RM ECONOMETRICS\\PROJECT\\R Simulations\\Excel results\\sim22_increasing_sparsity_with_multicollinearity_lasso_results.xlsx")
write_xlsx(OLS_results_df, "C:\\Users\\57300\\Documents\\Cristian Gutierrez\\Uni - Bonn\\5. Semester\\RM ECONOMETRICS\\PROJECT\\R Simulations\\Excel results\\sim22_increasing_sparsity_with_multicollinearity_OLS_results.xlsx")
write_xlsx(best_sim_MSE_lasso_sparse_df, "C:\\Users\\57300\\Documents\\Cristian Gutierrez\\Uni - Bonn\\5. Semester\\RM ECONOMETRICS\\PROJECT\\R Simulations\\Excel results\\sim22_increasing_sparsity_with_multicollinearity_best_sim_mse_lasso_results.xlsx")