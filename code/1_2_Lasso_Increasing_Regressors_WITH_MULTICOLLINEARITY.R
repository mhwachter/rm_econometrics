...
for (r in 1:length(reg_quan)){
  ...
  for (i in 1:rep){
    ...
    #Covariance matrix
    cov_sim = varcov_matrix_toeplitz(rho=rho, covariates=regressors, sigma_grid=sigma_grid)
    #Define DGP
...
write_xlsx(lasso_results_df, "C:\\Users\\57300\\Documents\\Cristian Gutierrez\\Uni - Bonn\\5. Semester\\RM ECONOMETRICS\\PROJECT\\R Simulations\\Excel results\\sim12_increasing_regressors_with_multicollinearity_lasso_results.xlsx")
write_xlsx(OLS_results_df, "C:\\Users\\57300\\Documents\\Cristian Gutierrez\\Uni - Bonn\\5. Semester\\RM ECONOMETRICS\\PROJECT\\R Simulations\\Excel results\\sim12_increasing_regressors_with_multicollinearity_OLS_results.xlsx")
write_xlsx(best_sim_mse_lasso_df, "C:\\Users\\57300\\Documents\\Cristian Gutierrez\\Uni - Bonn\\5. Semester\\RM ECONOMETRICS\\PROJECT\\R Simulations\\Excel results\\sim12_increasing_regressors_with_multicollinearity_best_sim_mse_lasso_results.xlsx")
